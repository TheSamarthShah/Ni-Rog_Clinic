...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <h1 style="text-align:center;"><strong>Free Time Slots</strong></h1>
    <br /><br />

    <div style="text-align:center; font-weight:600;"><asp:Label ID="PAppointment" runat="server"></asp:Label></div>
    <br /><br />
