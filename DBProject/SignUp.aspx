...
<body>
    ...
    <form id="SignUpPage" runat ="server"  >
        ...
        <div class="top-content" style="background:linear-gradient(90deg, rgba(143,127,153,1) 0%, rgba(191,185,185,1) 50%, rgba(240,176,196,1) 100%);"> 
            <div class="inner-bg">
               <div class="container">
                   ...
                   <div class="row">
                    ...
                    <div class="row">
                        ...
                        <!-- sign up form start honay laga hai :)-->
				            ...
				            <asp:button Text ="Sign Up"  runat="server" type="submit" class="btn btn-primary" OnClientClick="return validateS();" onclick="signupV"></asp:button>
        ...
        <!-- Footer -->
        <footer style="background:#726c75">
        	<div class="container">
        		<div class="row">
        			
        			<div class="col-sm-8 col-sm-offset-2">
        				<div class="footer-border"></div>
        				<p>Please feel free to contact us on 999999999</p>
                    </div>
